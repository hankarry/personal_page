...
create.id = "loading";
create.style = "position: fixed;z-index: 14;top: 0;width: 100vw;height: 100vh;animation-name: loading_show;animation-fill-mode: both;animation-duration: 1s;animation-delay: 0s;animation-timing-function: ease;"
...
// document.getElementById("loading").innerHTML = "<section>loading...</section>"
